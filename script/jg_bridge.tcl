...
-param top.axi_master_0.READONLY_INTERFACE 1\
-param top.axi_slave_5.WRITEONLY_INTERFACE 1\
-param top.axi_master_0.MAX_PENDING $maxpend\
-param top.axi_master_1.MAX_PENDING $maxpend\
-param top.axi_master_2.MAX_PENDING $maxpend\
...
-param top.axi_slave_6.MAX_PENDING $maxpend
...
assert -disable top.axi_master_2.genStableChks.genStableChksRDInf.genAXI4Full.slave_r_ruser_stable
assert -disable top.axi_master_2.genStableChks.genStableChksWRInf.genAXI4Full.slave_b_buser_stable
assert -disable top.axi_master_2.genPropChksRDInf.genAXI4Full.genRdIlOff.slave_r_ar_rid_no_interleave
assume -disable top.axi_master_2.genPropChksRDInf.genAXI4Full.master_ar_araddr_wrap_aligned
assume -disable top.axi_master_2.genPropChksRDInf.genAXI4Full.master_ar_araddr_wrap_arlen
assume -disable top.axi_master_2.genPropChksWRInf.genAXI4Full.master_aw_awaddr_wrap_aligned
assume -disable top.axi_master_2.genPropChksWRInf.genAXI4Full.master_aw_awaddr_wrap_awlen
...
assert -disable top.axi_slave_6.genPropChksRDInf.genAXI4Full.master_ar_arcache_no_ra_wa_for_uncacheable
assert -disable top.axi_slave_6.genPropChksWRInf.genAXI4Full.master_aw_awcache_no_ra_wa_non_modifiable
assert -disable top.axi_slave_6.genNoExChks.master_ar_arlock_no_excl_access_throttle_cnstr
assert -disable top.axi_slave_6.genStableChks.genStableChksWRInf.master_aw_awprot_stable
assert -disable top.axi_slave_6.genNoExChks.master_aw_awlock_no_excl_access_throttle_cnstr
assert -disable top.axi_slave_6.genStableChks.genStableChksRDInf.master_ar_arprot_stable
assert -disable top.axi_slave_6.genStableChks.genStableChksRDInf.genAXI4Full.master_ar_arlock_stable
assert -disable top.axi_slave_6.genStableChks.genStableChksRDInf.genAXI4Full.master_ar_arcache_stable
assert -disable top.axi_slave_6.genStableChks.genStableChksRDInf.genAXI4Full.master_ar_arqos_stable
assert -disable top.axi_slave_6.genStableChks.genStableChksRDInf.genAXI4Full.master_ar_arregion_stable
assert -disable top.axi_slave_6.genStableChks.genStableChksRDInf.genAXI4Full.master_ar_aruser_stable
assert -disable top.axi_slave_6.genStableChks.genStableChksWRInf.genAXI4Full.master_aw_awlock_stable
assert -disable top.axi_slave_6.genStableChks.genStableChksWRInf.genAXI4Full.master_aw_awcache_stable
assert -disable top.axi_slave_6.genStableChks.genStableChksWRInf.genAXI4Full.master_aw_awqos_stable
assert -disable top.axi_slave_6.genStableChks.genStableChksWRInf.genAXI4Full.master_aw_awregion_stable
assert -disable top.axi_slave_6.genStableChks.genStableChksWRInf.genAXI4Full.master_aw_awuser_stable
assert -disable top.axi_slave_6.genStableChks.genStableChksWRInf.genAXI4Full.master_w_wuser_stable
assert -disable top.axi_slave_6.genPropChksRDInf.genAXI4Full.master_ar_araddr_wrap_aligned
assert -disable top.axi_slave_6.genPropChksRDInf.genAXI4Full.master_ar_araddr_wrap_arlen
assert -disable top.axi_slave_6.genPropChksWRInf.genAXI4Full.master_aw_awaddr_wrap_aligned
assert -disable top.axi_slave_6.genPropChksWRInf.genAXI4Full.master_aw_awaddr_wrap_awlen
assume -disable top.axi_slave_6.genPropChksRDInf.genAXI4Full.genRdIlOff.slave_r_ar_rid_no_interleave
...
assume {((axi_slave_6.rready == 0) && (axi_slave_6.rvalid == 1)) |=> $stable(axi_slave_6.rdata)}
